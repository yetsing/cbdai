...
static MunitResult test_define(__attribute__((unused))
...
MunitTest symboltable_tests[] = {
    {(char *)"/test_define", test_define, NULL, NULL, MUNIT_TEST_OPTION_NONE,
     NULL},
    {(char *)"/test_resolve_global", test_resolve_global, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/test_resolve_local", test_resolve_local, NULL, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
