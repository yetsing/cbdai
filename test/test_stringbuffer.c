...
static MunitResult test_stringbuffer(__attribute__((unused))
...
static MunitResult
test_stringbuffer_line_prefix(__attribute__((unused))
                              const MunitParameter params[],
                              __attribute__((unused)) void *user_data) {
  char buf[1024];
  size_t length;
...
MunitTest stringbuffer_tests[] = {
    ...
    {(char *)"/test_stringbuffer_line_prefix", test_stringbuffer_line_prefix, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
