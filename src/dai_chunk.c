...
DaiOpCodeDefinition *dai_opcode_lookup(DaiOpCode op) {
...
void DaiChunk_init(DaiChunk *chunk, const char *filename) {
...
void DaiChunk_write(DaiChunk *chunk, uint8_t byte, int line) {
...
void DaiChunk_writeu16(DaiChunk *chunk, DaiOpCode op, uint16_t operand,
                       int line) {
...
void DaiChunk_reset(DaiChunk *chunk) {
...
int DaiChunk_addConstant(DaiChunk *chunk, DaiValue value) {
