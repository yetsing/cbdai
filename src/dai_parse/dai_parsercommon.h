...
static Precedence
token_precedences(DaiTokenType type) {
    switch (type) {
...
static bool
Parser_curTokenIs(Parser* p, DaiTokenType type);
static bool
Parser_peekTokenIs(Parser* p, DaiTokenType type);
static bool
Parser_expectPeek(Parser* p, DaiTokenType type);

static Precedence
Parser_curPrecedence(Parser* p);
static Precedence
Parser_peekPrecedence(Parser* p);
