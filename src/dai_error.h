...
DaiSyntaxError *
DaiSyntaxError_Newf(int lineno, int column, const char *fmt, ...) __attribute__((format(printf, 3, 4)));
...
DaiCompileError *
DaiCompileError_Newf(const char *filename, int lineno, int column, const char *fmt, ...) __attribute__((format(printf, 4, 5)));
...
DaiRuntimeError *
DaiRuntimeError_Newf(const char *filename, int lineno, int column, const char *fmt, ...) __attribute__((format(printf, 4, 5)));
