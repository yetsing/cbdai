...
static char *DaiAstClassMethodStatement_string(DaiAstBase *base, bool recursive) {
  ...
  DaiStringBuffer_write(sb, KEY_COLOR("type") ": " TYPE_COLOR("DaiAstType_ClassMethodStatement") ",\n");
...
static void DaiAstClassMethodStatement_free(DaiAstBase *base, bool recursive) {
  assert(base->type == DaiAstType_ClassMethodStatement);
  DaiAstClassMethodStatement *stmt = (DaiAstClassMethodStatement *)base;
...
DaiAstClassMethodStatement *DaiAstClassMethodStatement_New(void) {
